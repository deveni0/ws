...
zod.z.object({
  jid: zod.z.string().optional(),
  lid: zod.z.string().optional(),
...
zod.z.object({
  ...
  participants: zod.z.array(zod.z.object({
    ...
    admin: zod.z.enum(["admin", "superadmin"]).nullable().optional(),
...
var BotConfigSchema = zod.z.object({
  ...
  owners: zod.z.array(OwnerSchema2).default([]),
